...
export default function Testimonials() {
  return (
    <section id="testimonials" className="py-24 px-6 bg-black border-t border-white/[0.05] overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className="p-8 rounded-3xl bg-white/[0.02] border border-white/[0.05] flex flex-col justify-between space-y-8 hover:bg-white/[0.04] transition-colors"
            >
