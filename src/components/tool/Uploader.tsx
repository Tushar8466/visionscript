...
export default function Uploader({ onUploadComplete }: UploaderProps) {
  ...
  const handleFile = (file: File) => {
    ...
    startUploadMock(videoUrl, file);
  };

  const startUploadMock = (videoUrl: string, file: File) => {
    setIsUploading(true);
    let p = 0;
      ...
      >
        ...
        {isUploading ? (
          ...
          <div className="text-center space-y-6 z-10">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-bold text-white tracking-tight">Click or drag video to upload</h3>
